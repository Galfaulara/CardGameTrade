...
export declare class CatalogController {
    ...
    searchCanonicalCards(gameId: string, query?: string, page?: string, pageSize?: string): Promise<{
        query: string;
        items: {
    ...
    getCardDetail(canonicalCardId: string, printingId?: string): Promise<{
        card: {
            faces: any;
            power: string | null;
    ...
    getCardListings(canonicalCardId: string, printingId?: string, page?: string, pageSize?: string): Promise<{
        items: ({
            id: string;
