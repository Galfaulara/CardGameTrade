  ...
  return (
    <article className={`${styles.tile} ${layout === "grid" ? styles.gridTile : ""}`}>
      ...
      <div className={styles.details}>
        ...
        {relationship&&(relationship.owned>0||relationship.inWants)?<div className={styles.tags}>{relationship.owned>0?<span>Owned ×{relationship.owned}</span>:null}{relationship.inWants?<span>In Wants</span>:null}</div>:null}
